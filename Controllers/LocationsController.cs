...
namespace CalendarEvents.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public LocationsController(CalendarEventsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Locations != null ? 
                          ...
                          Problem("Entity set 'CalendarEventsContext.Locations'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CalendarEventsContext.Locations'  is null.");
            }
            var location = await _context.Locations.FindAsync(id);
            if (location != null)
            {
